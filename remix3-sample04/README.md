...
- **src/client.tsx**: Client-side hydration entry point using Remix 3 `run()`. Implements `app.dispose()` via `import.meta.hot.dispose` for clean hot-module-reloading (HMR).
